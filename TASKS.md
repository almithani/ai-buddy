...
- **Memory window shows settings**: DetailPanel lists both freeform preferences AND the `settings` table (friendly labels via `describeSetting`); deleting a setting reverts it to its default
